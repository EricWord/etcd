...
import (
	...
	"etcd-with-comments/etcdserver/api/v2discovery"
	"etcd-with-comments/pkg/fileutil"
	pkgioutil "etcd-with-comments/pkg/ioutil"
	"etcd-with-comments/pkg/osutil"
	"etcd-with-comments/pkg/transport"
	"etcd-with-comments/pkg/types"
	"etcd-with-comments/proxy/httpproxy"
...
var plog = capnslog.NewPackageLogger("etcd", "etcdmain")
