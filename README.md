...
[![Coverage](https://codecov.io/gh/etcd-io/etcd-with-comments/branch/master/graph/badge.svg)](https://codecov.io/gh/etcd-io/etcd)
...
[![Build Status Semaphore](https://semaphoreci.com/api/v1/etcd-io/etcd-with-comments/branches/master/shields_badge.svg)](https://semaphoreci.com/etcd-io/etcd)
[![Docs](https://img.shields.io/badge/docs-latest-green.svg)](https://etcd.io/docs)
[![Godoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/github.com/etcd-io/etcd)
[![Releases](https://img.shields.io/github/release/etcd-io/etcd-with-comments/all.svg?style=flat-square)](https://github.com/etcd-io/etcd-with-comments/releases)
[![LICENSE](https://img.shields.io/github/license/etcd-io/etcd.svg?style=flat-square)](https://github.com/etcd-io/etcd-with-comments/blob/master/LICENSE)
...
[etcdctl]: https://github.com/etcd-io/etcd-with-comments/tree/master/etcdctl
...
For more installation guides, please check out [play.etcd.io](http://play.etcd.io) and [operating etcd](https://github.com/etcd-io/etcd-with-comments/tree/master/Documentation#operating-etcd-clusters).
...
[github-release]: https://github.com/etcd-io/etcd-with-comments/releases
...
- Planning/Roadmap: [milestones](https://github.com/etcd-io/etcd-with-comments/milestones), [roadmap](./ROADMAP.md)
- Bugs: [issues](https://github.com/etcd-io/etcd-with-comments/issues)
...
A security vulnerability can be reported as an issue, however, GitHub and mailing lists may NOT always be an appropriate place for reporting vulnerabilities. In that case, please reach out to the project [MAINTAINERS](https://github.com/etcd-io/etcd-with-comments/blob/master/MAINTAINERS) to first discuss the vulnerabilities with them and take necessary action per such discussion.
