...
Benchmarking etcd performance can be done with the [benchmark](https://github.com/coreos/etcd-with-comments/tree/master/tools/benchmark) CLI tool included with etcd.
