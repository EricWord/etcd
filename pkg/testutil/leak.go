...
running(leaking) after all tests.
	...
	import "etcd-with-comments/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "etcd-with-comments/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "etcd-with-comments/pkg/logutil.(*MergeLogger).outputLoop") ||
